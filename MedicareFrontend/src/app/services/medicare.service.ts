...
export class MedicareService {
  ...
  private _productListUrl = "http://localhost:9595/api/medicare/product/list";
  private _orderListUrl = "http://localhost:9595/api/medicare/order/list";
  private _cartUrl = "http://localhost:9595/api/medicare/cart";
  private _customerUrl="http://localhost:9595/api/medicare/customer";
  private _adminCredentialUrl = "http://localhost:9595/api/medicare/admin/credential";
  private _customerCredentialUrl = "http://localhost:9595/api/medicare/customer/credential";
